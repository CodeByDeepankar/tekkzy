        ...
        <>
            <section className="hero">
                <div className="container hero-content">
                                        ...
                                        >
                                            Build Modern Digital Systems That Scale
                                        </motion.h1>
                                        <motion.p
                                            initial={{ opacity: 0, y: 20 }}
                                            animate={{ opacity: 1, y: 0 }}
                                        ...
                                        >
                                            Tekkzy helps teams launch secure cloud apps, automate workflows, and track growth with a platform designed for speed.
                                        </motion.p>
                                        <motion.div
                                            className="hero-btns"
                                            initial={{ opacity: 0, y: 20 }}
            ...
            <section className="cta-section">
                <div className="container">
                    <div className="cta-content-center">
                        ...
                        <p style={{ margin: '0 0 40px 0', maxWidth: '720px' }} className="text-xl text-slate-300">
                          Let&apos;s discuss how Tekkzy can help you achieve your digital goals.
                        </p>
                        <Link href="/contact" className="btn btn-primary" style={{ backgroundColor: 'var(--bg-white)', color: 'var(--primary-color)' }}>
